...
LastEditTime: 2024-10-30 14:51:23
...
async def get_farcaster_profile_from_cache(query_ids, expire_window):
    ...
    try:
        ...
        # logging.info("farcaster batch_profile_cache_keys={}".format(batch_profile_cache_keys))
...
async def batch_set_farcaster_profile_to_cache(exist_identity_records: typing.List[IdentityRecordSimplified], expire_window):
    aliases_map = {}
    ...
    try:
        ...
        if await RedisClient.acquire_lock(aliases_lock_key, aliases_unique_value, lock_timeout=30):
            ...
            for alias_cache_key, profile_key_values in aliases_map.items():
                ...
                # farcaster address may hold multiple farcaster profile
...
async def query_and_update_missing_query_ids(query_ids):
    ...
    if identity_records:
        asyncio.create_task(batch_set_farcaster_profile_to_cache(identity_records, expire_window=24*3600))
