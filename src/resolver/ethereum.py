...
LastEditTime: 2024-10-26 03:11:09
...
async def query_ethereum_profile_by_ids_cache(info, identities, require_cache=False):
    ...
    if require_cache is False:
        ...
        logging.debug("query_ethereum_profile_by_ids_cache input %s", filter_query_ids)
    ...
    logging.debug("batch query input filter_query_ids: {}".format(filter_query_ids))
    logging.debug("batch query missing_query_ids: {}".format(missing_query_ids))
    logging.debug("batch query require_update_ids: {}".format(require_update_ids))
    logging.debug("batch query cache_identity_records: {}".format(len(cache_identity_records)))
